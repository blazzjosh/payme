  ...
  <div class="bg-primary">
    ...
    <div class="flex min-h-screen">
      ...
      <div class="flex flex-row w-full">
        ...
        <!-- Sidebar -->
        <div class='hidden lg:flex flex-col justify-between bg-accent lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-[36rem]'>
          <div class="flex items-center justify-start space-x-3">
            <span class="bg-black rounded-full w-8 h-8"></span>
            <a href="/" class="font-medium text-xl">Payme</a>
          </div>
          <div class='space-y-5'>
        ...
        <div class="flex flex-1 flex-col items-center justify-center px-10 relative">
          ...
          <div class="flex flex-1 flex-col justify-center space-y-5 max-w-md">
            <div class="flex flex-col space-y-2 text-center">
              ...
              <p class="text-md md:text-xl">Sign up</p>
            </div>
            <div class="flex flex-col max-w-md space-y-5">
              ...
              <button on:click={handleLogin} class="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white">Sign in</button>
